...
namespace Vnit.ApplicationCore.Management
{
    ...
    /// </summary>
    public class VnitEngine : IEngine
    {
        #region Properties
        ...
        //}
        /// <summary>
        /// Register dependencies using Microsoft.Extensions.DependencyInjection 
        /// </summary>
        /// <param name="nopConfig">Startup Nop configuration parameters</param>
        /// <param name="services">Collection of service descriptors</param>
        /// <param name="typeFinder">Type finder</param>
        /// <param name="configuration"></param>
        protected virtual IServiceProvider RegisterDependencies(NopConfig nopConfig, IServiceCollection services, ITypeFinder typeFinder, IConfiguration configuration)
        {
            //register engine
            ...
            //register all provided dependencies
            foreach (var dependencyRegistrar in instances)
                dependencyRegistrar.Register(services, typeFinder, nopConfig, configuration);
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IVnitStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                //.Where(startup => PluginManager.FindPlugin(startup)?.Installed ?? true) //ignore not installed plugins
                .Select(startup => (IVnitStartup)Activator.CreateInstance(startup))
            ...
            RegisterDependencies(nopConfig, services, typeFinder, configuration);
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new VnitException("Unknown dependency");
                        return service;
                    });
            ...
            throw new VnitException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
