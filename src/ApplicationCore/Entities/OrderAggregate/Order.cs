...
using Vnit.ApplicationCore.Entities.Payments;
using Vnit.ApplicationCore.Entities.Shipping;
using Vnit.ApplicationCore.Enums;

namespace Vnit.ApplicationCore.Entities.OrderAggregate
{
    ...
    public class Order : BaseEntity, IAggregateRoot
    {
        ...
        public Order(string buyerId, Address shippingAddress, List<OrderItem> items)
        {
