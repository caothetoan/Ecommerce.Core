...
namespace Vnit.ApplicationCore.Entities.Catalog
{
    ...
    /// </summary>
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IStoreMappingSupported, IDiscountSupported
    {
        private ICollection<ProductCategory> _productCategories;
        private ICollection<ProductManufacturer> _productManufacturers;
        private ICollection<ProductMedia> _productPictures;
        ...
        /// </summary>
        public virtual ICollection<ProductMedia> ProductPictures
        {
            get => _productPictures ?? (_productPictures = new List<ProductMedia>());
