...
namespace Vnit.ApplicationCore.Services.Caching
{
    ...
    /// </summary>
    public partial class MemoryCacheService : ILocker, IStaticCacheManager
    {
        #region Fields
        ...
        public virtual T Get<T>(string key, Func<T> acquire, int? cacheTime = null)
        {
            ...
            if ((cacheTime ?? CachingConfig.CacheTime) > 0)
                Set(key, result, cacheTime ?? CachingConfig.CacheTime);
