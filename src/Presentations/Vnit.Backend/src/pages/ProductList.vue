...
export default {
  ...
  data () {
    return {
      ...
      search: "",
      headers: [
        { text: "Name", left: true, value: "name", mimeType: "text" },
        { text: "price", value: "price", mimeType: "number" },
        { text: "Description", value: "short", mimeType: "html" },
        { text: "Published", value: "published", mimeType: "boolean" },
        { text: "CreatedOnUtc", value: "createdOnUtc", mimeType: "datetime", format: "DD/MM/YYYY HH:mm:ss" }
      ],
      searchVm: {
        contains: {
          name: "",
  ...
  methods: {
    ...
    getItems () {
      this.query = "";
      this.quickSearch = "";
      Store.dispatch("products/getItems", {
