  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: "TotalPrice", value: "TotalPrice", mimeType: "number" },
        { text: "Description", value: "Description", mimeType: "html" },
        { text: "Status", value: "Status", mimeType: "boolean" },
        { text: "CreateDate", value: "CreateDate", mimeType: "datetime", format: "DD/MM/YYYY HH:mm:ss" }
      ],
      searchVm: {
        contains: {
          name: "",
