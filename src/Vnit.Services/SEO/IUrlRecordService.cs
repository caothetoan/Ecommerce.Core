...
{
    public interface IUrlRecordService : IBaseEntityService<UrlRecord>
    {
        /// <summary>
        ...
        /// <returns></returns>
        UrlRecord GetUrlRecord<T>(T entity, string typeName = "", bool isUpdate = false) where T : IPermalinkSupported;
